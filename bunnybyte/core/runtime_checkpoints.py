...
class RuntimeCheckpointsMixin:
    ...
    def restore_checkpoint(self, checkpoint_id):
        """Checkpoint restore is intentionally session-only.

        Forking rewinds conversation state by creating a child session with
        truncated history. It does not mutate files or reset the workspace.
        """
