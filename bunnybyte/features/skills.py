...
SKILL_FILE_CREATION_GUIDE = """When creating BunnyByte skill files at .bunnybyte/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${BUNNYBYTE_SKILL_DIR}": self.skill_root,
        }
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".bunnybyte" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".bunnybyte" / "skills", "project"),
    ]
